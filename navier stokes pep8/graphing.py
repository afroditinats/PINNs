...
1. noise_types --> noise_levels

2. spaces

3. plt. commands instead of ([0, 0.5, 1, 2, 3, 5, 7, 10, 25] --> noise_levels

4.  plt.savefig('./plots/paremeter_identification_accuracy.png') (typo)
--> plt.savefig('./plots/parameter_identification_accuracy.png')

5. plt.plot(noise_levels, [0.1] * 8, label="Ground truth", color="green")
--> instead of [0.1] * 8 (8 is the length of the noise_levels we use in the experiment)
    we use: plt.plot(noise_levels, [0.1] * len(noise_levels), label="Ground truth", color="green")
"""

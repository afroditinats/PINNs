...
3. for sample in range(0, samples): --> for sample in range(samples):
...
5.  print("Sample: ", str(sample + 1), " out of ", str(samples)) ----> we can remove the str from the values
    print("Noise level:" + str(noise_level))
    print("Estimated parameter:" + str(noise_estimated_parameter[-1]))
    print("Test set, RMSE: " + str(noise_rmse[-1]))
    print("Test set, RMSE with FEM: " + str(noise_fem_error[-1]))
    print(noise)  --> we can remove it 
    print(noise_rmse) --> we can remove it 
    print(noise_estimated_parameter) --> we can remove it 
    print(noise_parameter_error) --> we can remove it 
    print(noise_fem_error) --> we can remove it 
